...
def SSD300(input_shape, num_classes=21, para_table = None):
    ...
    priorbox = PriorBox(img_size, para_table[0],max_size = para_table[1], aspect_ratios=[2],
    ...
    priorbox = PriorBox(img_size, para_table[1], max_size=para_table[2], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, para_table[2], max_size=para_table[3], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, para_table[3], max_size=para_table[4], aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, para_table[4], max_size=para_table[5], aspect_ratios=[2],
                        variances=[0.1, 0.1, 0.2, 0.2],
    ...
    priorbox = PriorBox(img_size, para_table[5], max_size=para_table[6], aspect_ratios=[2],
                        variances=[0.1, 0.1, 0.2, 0.2],
